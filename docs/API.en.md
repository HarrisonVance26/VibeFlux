# VibeFlux API Reference (English)

[中文 API](API.zh-CN.md) | [Back to README](../README.md#english-documentation)

This document is generated from public classes, functions, and methods in the current `VibeFlux` package. Private names starting with an underscore are not listed.

## Module Index

- [`VibeFlux._runtime`](#vibefluxruntime) - Runtime dependency checks.
- [`VibeFlux.base.Encode`](#vibefluxbaseencode) - Captcha image generation.
- [`VibeFlux.base.Extension`](#vibefluxbaseextension) - Low-level extended widgets.
- [`VibeFlux.base.Manager`](#vibefluxbasemanager) - Base SQLite connection management.
- [`VibeFlux.base.Plots`](#vibefluxbaseplots) - Chart, rectangle, and oriented-box drawing functions.
- [`VibeFlux.base.Processor`](#vibefluxbaseprocessor) - Media and image processing signal bases.
- [`VibeFlux.base.Sets`](#vibefluxbasesets) - QSS and YAML settings loaders.
- [`VibeFlux.base.Tips`](#vibefluxbasetips) - Toast widgets and fade animations.
- [`VibeFlux.base.Trans`](#vibefluxbasetrans) - OpenCV / Qt image conversion.
- [`VibeFlux.base.Utils`](#vibefluxbaseutils) - Basic path helpers.
- [`VibeFlux.base.Visual`](#vibefluxbasevisual) - Core visualization for detection, segmentation, keypoints, and classification.
- [`VibeFlux.base.VisualConf`](#vibefluxbasevisualconf) - Class name and color configuration.
- [`VibeFlux.base.Widget`](#vibefluxbasewidget) - Low-level window, dialog, and settings editor bases.
- [`VibeFlux.config.QfConfig`](#vibefluxconfigqfconfig) - Global runtime configuration.
- [`VibeFlux.config.VisualConf`](#vibefluxconfigvisualconf) - Visualization configuration readers.
- [`VibeFlux.examples.llm_usage`](#vibefluxexamplesllmusage) - Public module.
- [`VibeFlux.handlers.Handler`](#vibefluxhandlershandler) - Camera, video, image, and image-folder handlers.
- [`VibeFlux.llms.Client`](#vibefluxllmsclient) - OpenAI-compatible LLM client.
- [`VibeFlux.llms.Config`](#vibefluxllmsconfig) - API key and LLM configuration management.
- [`VibeFlux.llms.Message`](#vibefluxllmsmessage) - Text, image, and file message builders.
- [`VibeFlux.llms.QtBridge`](#vibefluxllmsqtbridge) - PySide6 background-thread LLM calls.
- [`VibeFlux.llms.Registry`](#vibefluxllmsregistry) - Provider and model registry.
- [`VibeFlux.llms.Templates`](#vibefluxllmstemplates) - Structured output templates.
- [`VibeFlux.llms.Updater`](#vibefluxllmsupdater) - Refresh model lists from provider /models endpoints.
- [`VibeFlux.manager.DetManager`](#vibefluxmanagerdetmanager) - Detection result SQLite manager.
- [`VibeFlux.manager.UserManager`](#vibefluxmanagerusermanager) - User registration, login, and avatar management.
- [`VibeFlux.models.AbstractModel`](#vibefluxmodelsabstractmodel) - Abstract detector model interface.
- [`VibeFlux.models.Heatmap`](#vibefluxmodelsheatmap) - PyTorch hook-based heatmap generation.
- [`VibeFlux.path.FManager`](#vibefluxpathfmanager) - File copy, delete, search, and text replacement tools.
- [`VibeFlux.path.Path`](#vibefluxpathpath) - Path joining, listing, moving, and copying tools.
- [`VibeFlux.RecSystem`](#vibefluxrecsystem) - Qt resource system entry points, usually imported internally.
- [`VibeFlux.styles.Formers`](#vibefluxstylesformers) - YAML UI settings application functions.
- [`VibeFlux.styles.Styles`](#vibefluxstylesstyles) - QSS theme and style application.
- [`VibeFlux.utils.CameraUtils`](#vibefluxutilscamerautils) - Camera discovery, resolution, and property helpers.
- [`VibeFlux.utils.DetVisual`](#vibefluxutilsdetvisual) - Public detection visualization wrappers.
- [`VibeFlux.utils.FileUtils`](#vibefluxutilsfileutils) - QSS reading and YAML config access.
- [`VibeFlux.utils.ImageUtils`](#vibefluxutilsimageutils) - Image reading, charts, and detection-box drawing helpers.
- [`VibeFlux.utils.Pixmap`](#vibefluxutilspixmap) - OpenCV image to QPixmap conversion.
- [`VibeFlux.utils.Sysinfo`](#vibefluxutilssysinfo) - System and runtime diagnostics.
- [`VibeFlux.widgets.BaseFrame`](#vibefluxwidgetsbaseframe) - Window bases, login dialog, animation, table, and image display helpers.
- [`VibeFlux.widgets.ExtWidgets`](#vibefluxwidgetsextwidgets) - Image label, window controls, and message box widgets.
- [`VibeFlux.widgets.SettingsDialog`](#vibefluxwidgetssettingsdialog) - YAML settings and generic config editor dialogs.
- [`VibeFlux.widgets.TipsWidgets`](#vibefluxwidgetstipswidgets) - Multi-type toast widgets.
- [`VibeFlux.widgets.Widgets`](#vibefluxwidgetswidgets) - User-facing Qt widget wrappers.
...
Base SQLite connection management.
...
Chart, rectangle, and oriented-box drawing functions.
...
Media and image processing signal bases.
...
Toast widgets and fade animations.
...
Core visualization for detection, segmentation, keypoints, and classification.
...
Class name and color configuration.
...
Low-level window, dialog, and settings editor bases.
...
Visualization configuration readers.
...
Camera, video, image, and image-folder handlers.
...
API key and LLM configuration management.
...
Text, image, and file message builders.
...
PySide6 background-thread LLM calls.
...
Refresh model lists from provider /models endpoints.
...
Detection result SQLite manager.
...
User registration, login, and avatar management.
...
Abstract detector model interface.
...
PyTorch hook-based heatmap generation.
...
File copy, delete, search, and text replacement tools.
...
Path joining, listing, moving, and copying tools.
...
Qt resource system entry points, usually imported internally.
...
YAML UI settings application functions.
...
QSS theme and style application.
...
Camera discovery, resolution, and property helpers.
...
Public detection visualization wrappers.
...
QSS reading and YAML config access.
...
Image reading, charts, and detection-box drawing helpers.
...
OpenCV image to QPixmap conversion.
...
Window bases, login dialog, animation, table, and image display helpers.
...
Image label, window controls, and message box widgets.
...
YAML settings and generic config editor dialogs.
...
User-facing Qt widget wrappers.
