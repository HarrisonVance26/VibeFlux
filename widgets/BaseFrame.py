...
from ..base.Encode import imRandCode
from ..base.Trans import ToQtPixmap, scalePixmap, setPixmap
from ..base.Widget import IMDialog, IMainWindow
...
def getFramePath(file_path: str, cur_frames: int, imageHandler: ImageHandler = None,
    ...
    Args:
        ...
        imageHandler (ImageHandler, optional): An instance of `VibeFlux.handlers.ImageHandler` used
